...
const showProducts = (products) => {
  ...
  for (const product of products) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4 class="text-color">${product.title.slice(0,67)}</h4>
      <h5>Category: ${product.category}</h5>
      <h5>Rating:<span class="numberText"><b> ${product.rating.rate}</b></span> By<span class="numberText"><b> ${product.rating.count} </b></span>Users</h5>
      <h4><b>Price: <span class="numberText">$${product.price}</span> </b></h4>     
...
//calling all the function from here
  let count = 0;
